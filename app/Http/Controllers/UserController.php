...
class UserController extends Controller
{
	public function showUser($id){
		...
		$califications=DB::table('posts')->where('type',1)->where('user_id',$id)->select(DB::raw('count(0) as number'),'calification')->groupBy('calification')->orderBy('calification','desc')->get();

...
<div class="row p-1" style="border: 1px #f2f2f2 solid;border-radius: 15px;">
	...
	<div class="col-10" style="font-size: small;">
		@foreach($califications as $calification)
		<a href="{{route('showPostCalificationProfile',$calification->calification)}}" title="Ver reviews calificadas por ti con {{$calification->calification}} estrellas"><div class="progress my-1">
